...
def main():
    ...
    # create the trainer
    trainer = PPOTrainer(policy, env, learning_rate=0.001, learning_rate_critic=0.001, episodes=30000, sample_size=4096, batch_size=1024, gamma=0.995, clipping_value=0.3)
